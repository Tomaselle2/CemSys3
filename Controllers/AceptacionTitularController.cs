...
{
    public class AceptacionTitularController : Controller
    {
        ...
        public AceptacionTitularController(IArchivo archivoService, IHistorialEstados historialService, IStrategyFactory factory,
        IDocumentoTramiteService documentoService, ITarea tareaService, ITramiteCreateStrategy<CrearTramiteDTO, CambioTitularDTO> strategy, IStrategyFactory strategyFactory)
        {
        ...
        public async Task<IActionResult> GenerarAutorizaciones(CambioTitularVM viewModel)
        {
            ...
            ITramiteStrategy strategy = _factory.GetStrategy((int)TipoTramiteEnum.AceptacionTitular);
        ...
        public async Task<IActionResult> IniciarTramite(int concesionId, int tipoTramiteId)
        {
            try
            {
                ...
                int tramiteId = await strategy(dto);
