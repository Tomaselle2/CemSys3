...
namespace CemSys3.Controllers
{
    public class PlantillaTramiteController : Controller
    {
        ...
        [HttpGet]
        [AuthorizeRole(RolUsuario.Administrador)]
        public async Task<IActionResult> CremacionLibreTransito(int plantillaId)
        {
            PlantillaTramiteVM viewModel = new PlantillaTramiteVM();
            viewModel.SweetAlert = TempData.GetSweetAlert();
        ...
        [HttpGet]
        [AuthorizeRole(RolUsuario.Administrador)]
        public async Task<IActionResult> ReduccionAutorizacion(int plantillaId)
        {
            PlantillaTramiteVM viewModel = new PlantillaTramiteVM();
            viewModel.SweetAlert = TempData.GetSweetAlert();
            ...
            try
            {
                ...
                viewModel.vista = "ReduccionAutorizacion";
        ...
        [HttpGet]
        [AuthorizeRole(RolUsuario.Administrador)]
        public async Task<IActionResult> PermisoIngreso(int plantillaId)
        {
            PlantillaTramiteVM viewModel = new PlantillaTramiteVM();
            viewModel.SweetAlert = TempData.GetSweetAlert();
            ...
            try
            {
                ...
                viewModel.vista = "PermisoIngreso";
        ...
        [HttpGet]
        [AuthorizeRole(RolUsuario.Administrador)]
        public async Task<IActionResult> PermisoRefaccion(int plantillaId)
        {
            PlantillaTramiteVM viewModel = new PlantillaTramiteVM();
            viewModel.SweetAlert = TempData.GetSweetAlert();
            ...
            try
            {
                ...
                viewModel.vista = "PermisoRefaccion";
