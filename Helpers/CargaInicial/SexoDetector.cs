namespace CemSys3.Helpers.CargaInicial
{
    ...
    public static class SexoDetector
    {
        private static readonly HashSet<string> NombresMasculinos = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "ORLANDO","REMIGIO","RENE","SANTOS","TOBIAS","URBANO","VALERIO","WILSON","YAMIL", "DAVID", "GERMAN", "ESTEVAN",
            "ELOY", "PASCUAL", "FELIX", "CANDOR", "EDGAR", "EDUBIGES", "NELSON", "ORTIZ", "BARTOLOMÉ", "EDIL", "ADIP", "AQUILES",
            "ANTENOR", "ANTOLIN", "PRIORI", "HERNAN", "JULIAN", "ALEM", "FERMIN", "ZENON", "CONCI", "FILEMON", "MARCIAL",
            "FABIAN", "BENJAMIN", "ROBIN", "ALBERTOI", "CLEMAR", "GIAN", "SIMEON", "ZACARIAS", "ORESTES", "KEVIN", "FIDEL",
            "EXEQUIEL", "ISAIAS", "ALAN", "SERAFIN"
        };
        ...
        private static readonly HashSet<string> NombresFemeninos = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "YESICA","YAMILET","ZULEMA","ZORAIDA","AZUCENA","ROSMERI","MAITE", "IBON", "GLADYS",
            "VIRTUDES", "NANCI", "NELLY", "FANY", "DOLLI", "FANNY", "LEONOR", "EDELVEIS", "JUDITH",
            "YNES", "BORTOLI", "ELISABETH", "DAMARIS", "MARICEL", "NIEVES", "VALLEJOS", "LEONOR", "LUCI",
            "GINES", "ENCARNACION", "NATIVIDAD", "ESTACION", "PRESENTACION", "CRISPIN", "INGRID", "MIRYAM",
            "NANCY", "DOLI", "EMPERATRIZ", "JENIFER"
        };
